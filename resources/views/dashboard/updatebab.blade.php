...
<div class="pt-4 pb-2">
    <h5 class="card-title text-center pb-0 fs-4" style="color: #6ab04c">Update Data Bab Buku</h5>
  </div>

  <form class="row g-3 needs-validation" action="/register" method="post">
    @csrf
    <div class="col-12">
        <label for="yourEmail" class="form-label">Bab Ke-</label>
        <input type="number" name="keterangan" class="form-control" id="yourEmail" required>
        <div class="invalid-feedback">Mohon input urutan bab</div>
      </div>
      
    <div class="col-12">
      <label for="yourName" class="form-label">Judul Buku</label>
      <input type="text" name="judul" class="form-control" id="yourName" required>
      <div class="invalid-feedback">Mohon input judul buku</div>
    </div>
