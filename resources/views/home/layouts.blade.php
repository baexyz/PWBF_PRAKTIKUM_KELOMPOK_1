        ...
        <ul>
          ...
          <li class="dropdown"><a href="about"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="trainers">Pendiri</a></li>
              <li><a href="trainers">Pengajar </a></li>
          ...
          <li class="dropdown"><a href="events"><span>Publikasi</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              </li>
              <li><a href="events">Berita</a></li>
              <li><a href="events">Kegiatan</a></li>
              <li><a href="events">Galeri </a></li>
            </ul>
          </li>
